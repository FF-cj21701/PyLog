...
def _build_context(payload: dict, project_root: str, filename: str, stdout_buffer: io.StringIO) -> dict:
...
def run_payload(payload: dict) -> dict:
    ...
    try:
        ...
        context = _build_context(payload, project_root, filename, stdout_buffer)
